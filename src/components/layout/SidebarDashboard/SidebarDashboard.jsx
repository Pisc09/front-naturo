...
const navigation = [
  ...
  { name: "Team", to: "/dashboard/recherche", icon: UsersIcon, current: false },
  {
    name: "Projects",
...
const userNavigation = [
  { name: "Votre profile", to: "/dashboard/profil" },
  { name: "Déconnexion", to: "/register" },
];
        ...
        >
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              ...
              {/* SidebarDashboard component, swap this element with another sidebar if you like */}
